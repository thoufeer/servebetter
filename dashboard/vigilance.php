<!DOCTYPE html>
<html>
<head><title>Dashboard - Service Tracker</title>
<meta charset="utf-8">
                ...
                <div class="right-part">
                    <form class="form-horizontal" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="email" placeholder="Enter Aadhaar Number">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-4">Mobile Number:</label>
                            <div class="col-sm-8"> 
                                <input type="password" class="form-control" id="pwd" placeholder="Enter Mobile Number">
                            </div>
                        </div>
